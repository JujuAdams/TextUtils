...
function TextUtilsCacheFontInfo(_font)
{
    static _cache          = {};
    static _spriteFontData = {};
    ...
    if (_fontInfo == undefined)
    {
        ...
        var _fastGlyphMap = ds_map_create();
        _fontInfo.fastGlyphs = _fastGlyphMap;
        ...
        repeat(array_length(_glyphNameArray))
        {
            ...
            _fastGlyphMap[? ord(_name)] = _glyphInfo;
            ++_i;
        }
        ...
        if ((_fontInfo.texture < 0) && (_fontInfo.spriteIndex >= 0))
        {
            ...
            repeat(array_length(_glyphNameArray))
            {
                ...
                _glyphInfo.offset  = 1 - _spriteXOffset + _xOffset;
                _glyphInfo.yOffset = 1 - _spriteYOffset + _imageInfo.y_offset;
